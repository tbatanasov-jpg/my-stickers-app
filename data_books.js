...
let allBooks = [
    { 
        ...
        description: 'Магнитна книжка, посветена на най-значимите архитектурни резервати в България.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'Магнитна книжка, посветена на най-значителните манастири в България.<br><br><br><br><span style="font-weight: normal;">.</span>',
      ...
      { 
        ...
        description: 'Традиционна българска кухня е формирана от сливането на кухните на траки, славяни и прабългари. Всяка етническа група включва своите кулинарни традиции.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'България се е прославила през вековете със своята маслодайната роза, която е с най-високо качество. От цветовете на розите се получава Розово масло и Розова вода.<br><br><br><br><span style="font-weight: normal;">.</span>',
    ...
    { 
        ...
        description: 'Късноантична римска крепост и укрепено селище, възникнало през VI век преди Христа.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'Со̀фия е столицата на България. Тя е древен град, който е оцелял през вековете. Днес София е основен административен, индустриален, транспортен, културен и образователен център на страната.<br><br><br><br><span style="font-weight: normal;">.</span> ',
      ...
      { 
        ...
        description: 'Най-старият археологически музей в България, съществуващ от 1892 г. Разполага с пет основни изложбени зали: Централна зала, зала „Праистория“, зала „Средновековие“, зала „Трезор“ и зала за временни изложби.<br><br><br><br><span style="font-weight: normal;">.</span>  ',
    ...
    { 
        ...
        description: 'Боянската църква „Св. св. Никола и Пантелеймон“ е средновековна българска църква. Представлява двуетажена църква-гробница с долен етаж, предназначен за крипта (гробница) и горен - семеен параклис.<br><br><br><br><span style="font-weight: normal;">.</span>',
    ...
    { 
        ...
        description: 'Най-големият музей в България. В сегашната си сграда се помещава от 1998 г. Колекциите му съдържат над 650 000 експоната.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'Музеят е основан на 13 май 1957 г. Във фондовете си Националният политехнически музей съхранява над 22 000 експоната. Разпределени са по колекции: времеизмерване, транспорт, фотографска техника и кинотехника, оптика, звукозапис, радио и телевизия, изчислителна техника, музикални механизми, геодезически уреди, измервателна техника, битова техника, шевни машини, пишещи машини, физични уреди, съобщителна техника.<br><br><br><br><span style="font-weight: normal;">.</span>',
        ...
        description: 'Град Копривщица е единствения град музей в страната. През 1971 г. е обявен за архитектурен и исторически резерват, разполагащ с 388 архитектурни, исторически, художествени и етнографски паметници.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: ' Първият планински курорт в България. Предлага отлични условия за планински туризъм и спорт: алпийски ски, сноуборд, ски бягане, планинско колоездене.<br><br><br><br><span style="font-weight: normal;">.</span>',
        ...
        description: ' Седемте рилски езера са група езера с ледников произход, разположена в Рила планина. Името на всяко от езерата отразява някоя негова особеност.<br><br><br><br><span style="font-weight: normal;">.</span>.',
    ...
    { 
     ...
     { 
        ...
        description: 'Културен и образователен център на Югозападна България. Намира се на 360 m надморска височина в близост до Пирин планина.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'Пирамидите са сложна композиция от остри и игловидни пирамидални или конусовидни земни форми.<br><br><br><br><span style="font-weight: normal;">.</span>',
    ...
    { 
        ...
        description: 'Манастир „Свети Йоан Рилски“ е ставропигиален манастир на Българската православна църква. Той е сред най-значимите културни паметници в България.<br><br><br><br><span style="font-weight: normal;">.</span> ',
        coords: { lat: 42.1336, lng: 23.3402 } 
    },
    { 
        ...
        description: 'Един от големите зимни курорти в България. Намира се в подножието на Пирин, на 927 м надморска височина.<br><br><br><br><span style="font-weight: normal;">.</span>',
        ...
        description: ' Градът представлява природен санаториум за лечение на заболявания на дихателната система, намиращ се в подножието на Пирин планина. <br><br><br><br><span style="font-weight: normal;">.</span>',
    ...
    { 
        ...
        description: ' Една от най-големите пещери в България. Общата дължина на галериите ѝ е 2,5 км. В пещерата се поддържа постоянна температура от 12 °C. <br><br><br><br><span style="font-weight: normal;">.</span>',
    ...
    { 
        ...
        description: ' Най-малкият град в България. Намира се в югозападните части на Пирин планина. Основен поминък на населението са винопроизводството и туризмът.<br><br><br><br><span style="font-weight: normal;">.</span>  ',
    ...
    { 
        ...
        description: ' Градът е разположен край река Искър. Основан е, когато се построява железопътната линия София – Горна Оряховица в края на 19 век.<br><br><br><br><span style="font-weight: normal;">.</span>',
    ...
    { 
        ...
        description: ' Разположен в полите на Врачанската планина. Административен и стопански център на едноименната област.<br><br><br><br><span style="font-weight: normal;">.</span>',
    ...
    { 
        ...
        description: ' Градът е сред атрактивните туристически обекти на България. Предлага възможности за туризъм, алпинизъм, лов и риболов.<br><br><br><br><span style="font-weight: normal;">.</span>',
        ...
        description: ' Град с многовековна история, разположен на северозападния бряг на река Дунав.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: ' Древен град с над 2500-годишна история. Местоположението и природните условия на района благоприятстват стопанското развитие и търговията.<br><br><br><br><span style="font-weight: normal;">.</span>',
      ...
      { 
        ...
        description: ' Една от най-красивите пещери на България. Богата е на сталактити, сталагмити, сталактони, хеликтити и дендрити.<br><br><br><br><span style="font-weight: normal;">.</span>',
    ...
    { 
        ...
        description: 'Административен център на област Плевен. Градът е туристически център, известен като „Град на музеите“.<br><br><br><br><span style="font-weight: normal;">.</span>',
        ...
        description: ' Градът е разположен от двете страни на река Осъм. Средната надморска височина на Ловеч е 360 м. <br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: ' Третия по големина ставропигиален манастир в България. Основан е около 1600 година на брега на река Черни Осъм.<br><br><br><br><span style="font-weight: normal;">.</span> ',
      ...
      { 
        ...
        description: ' Най-големият български град по поречието на река Дунав, известен с богатото си историческо минало и великолепната си архитектура. <br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: ' Територията на природния парк е 3260 хектара. Намира се на около 20 км от град Русе. На много места в парка има следи от тракийски селища и светилища.<br><br><br><br><span style="font-weight: normal;">.</span>',
        ...
        description: 'Свищов е град в Северна България, разположен на брега на река Дунав. Той е известен като важен търговски и културен център още от Възраждането. Градът впечатлява с красива крайдунавска алея и богато историческо наследство.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'Силистра е град в Североизточна България. Той е сред най-старите градове в страната. В Силистра се намира крепост "Меджиди табия", запазена османска военна постройка. Градът е известен със своя живописен Дунавски парк и културни традиции.<br><br><br><br><span style="font-weight: normal;">.</span>',
      ...
      { 
        ...
        description: 'Живописно село, намиращо се близо до Велико Търново. То е известно със своите възрожденски къщи и богато културно-историческо наследство. Сред най-забележителните му обекти е Църква „Рождество Христово“, прочута със стенописите си.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'Историко-археологически резерват, разположен край село Свещари. Районът е известен с богатото си тракийско наследство и живописната природа. В него се намира "Свещарска гробница". Резерватът привлича посетители със съчетание от история, археология и природна красота.<br><br><br><br><span style="font-weight: normal;">.</span>',
    ...
    { 
        ...
        description: 'Живописен град в Централна Северна България. Той е известен със своите традиции в занаятите, особено прочутата троянска керамика. Троян привлича посетители с красива природа и възможности за туризъм.<br><br><br><br><span style="font-weight: normal;">.</span>',
      ...
      { 
        ...
        description: 'Малък възрожденски град, известен със своята добре запазена  възрожденска архитектура. В града се намира архитектурно-историческият комплекс Даскалоливница, свързан с развитието на просветното дело у нас. Елена привлича посетители с красива природа, традиции и усещане за автентичен български дух.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'Възрожденски град, сгушен в полите на Стара планина. Той е известен със своята дърворезбарска и иконописна школа. Сред символите на града е Часовниковата кула в центъра на стария град. Трявна впечатлява с калдъръмените си улички, възрожденските къщи и уютната си атмосфера.<br><br><br><br><span style="font-weight: normal;">.</span>',
     ...
     { 
        ...
        description: 'Градът е разположен по поречието на река Янтра. Известен е като столицата на хумора и сатирата в страната. В града се намира "Дом на хумора и сатирата". Габрово съчетава богати възрожденски традиции, индустриална история и красиви планински пейзажи.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
     ...
     { 
        ...
        description: 'Град в Североизточна България с богата история и стратегическо значение. Над него се намира Шуменска крепост, която има тракийско, римско и средновековно минало. В близост до града се намира Паметник „Създатели на българската държава“, посветен на 1300-годишнината на България.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'Уникален скален релеф, изсечен върху отвесна скала край село Мадара. Датиран е през VIII век и изобразява конник в естествена големина, който пронизва лъв с копие. Паметникът е свързан с ранната българска държава. Включен в списъка на световното културно наследство на ЮНЕСКО.<br><br><br><br><span style="font-weight: normal;">.</span>',
    ...
    { 
        ...
        description: 'Варна е най-големият град по българското Черноморие и често е наричан морската столица на страната. Той е важен културен, туристически и икономически център с дълга история, започваща още от античността. Сред най-известните му забележителности са Варненски археологически музей и красивата Морска градина.<br><br><br><br><span style="font-weight: normal;">.</span>',
      ...
      { 
        ...
        description: 'Аладжа манастир е средновековен скален манастир, разположен близо до Варна. Манастирът е издялан директно в скалите и представлява уникален комплекс от килии, църкви и коридори. Смята се, че е бил действащ между XIII и XIV век и е свързан с отшелническия живот на монасите.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'Обзор е живописен морски курорт, разположен на българското Черноморие между Варна и Бургас. Градът е известен със своите широки плажове, чиста морска вода и спокойна атмосфера, подходяща както за семейни почивки, така и за отдих сред природата. В района има исторически забележителности, като останките от античния град Несебърския крепостен комплекс и живописни хълмове с панорамни гледки.<br><br><br><br><span style="font-weight: normal;">.</span> ',
    ...
    { 
        ...
        description: 'Свети Св. Константин и Елена е един от най-старите и популярни български морски курорти, разположен близо до Варна. Той е известен с минералните си извори и лечебни спа центрове, които привличат туристи целогодишно. Курортът предлага красива природа, плажове и възможности за спорт и отдих сред спокойна обстановка.<br><br><br><br><span style="font-weight: normal;">.</span>',
        coords: { lat: 43.2279, lng: 28.0080 } 
    },
      { 
        id: 'b051', title: '- Златни пясъци', location: 'Варна', 
        isCollected: false, isWanted: false,
        imagePath: 'Images/Books/b051.png', 
        description: 'Златни пясъци е един от най-известните български морски курорти, разположен северно от Варна. Курортът е известен с широките си златисти плажове, чистото Черно море и оживен нощен живот. Златни пясъци предлага разнообразни възможности за спорт, от водни спортове до пешеходни и вело маршрути в близката природна зона.<br><br><br><br><span style="font-weight: normal;">.</span> ',
        coords: { lat: 43.2802, lng: 28.0420 } 
    },
    { 
        id: 'b052', title: '- Антична крепост - Бяла', location: 'Бяла', 
        isCollected: false, isWanted: false, 
        imagePath: 'Images/Books/b052.png', 
        description: 'Антична крепост на нос Свети Атанас се намира на красивия нос Свети Атанас край морския град Бяла на Българското Черноморие. Останките датират от късната античност и ранновизантийския период (V–VI век), когато тук е съществувал укрепен град с порта и религиозни сгради като базилика и баптистерий. Археологическите разкопки разкриват части от улици, сгради, винарна и декоративни елементи, които показват богатството и значението на този древен център.<br><br><br><br><span style="font-weight: normal;">.</span>',
        coords: { lat: 42.8548, lng: 27.9017 } 
    },
         { 
        id: 'b053', title: '- Албена', location: 'Албена', 
        isCollected: false, isWanted: false,
        imagePath: 'Images/Books/b053.png', 
        description: 'Албена е един от най-известните и модерни български морски курорти, разположен северно от Балчик. Курортът е известен с широките си златисти плажове, чистата вода и добре поддържаната зелена зона, което го прави подходящ за семейни почивки. Албена предлага разнообразие от хотели, спа и спортни комплекси, както и възможности за водни спортове и анимация за туристи от всички възрасти.<br><br><br><br><span style="font-weight: normal;">.</span>',
        coords: { lat: 43.3692, lng: 28.0820 } 
    },
    { 
        id: 'b054', title: '- Балчик', location: 'Балчик', 
        isCollected: false, isWanted: false, 
        imagePath: 'Images/Books/b054.png', 
        description: 'Балчик е живописен морски курорт, разположен северно от Варна, известен със своите красиви заливи и спокойна атмосфера. Градът впечатлява с архитектурни и исторически забележителности, като Двореца в Балчик и ботаническата градина към него. Балчик е популярен и с пешеходни алеи, уютни кафенета и артистична атмосфера, която привлича творчески туристи.<br><br><br><br><span style="font-weight: normal;">.</span>',
        coords: { lat: 43.4060, lng: 28.1483 } 
    },
      { 
        id: 'b054А', title: '- Музеите в Балчик', location: 'Балчик', 
        isCollected: false, isWanted: false,
        imagePath: 'Images/Books/b054А.png', 
        description: 'Балчик предлага няколко интересни музея, които представят историята, културата и изкуството на региона. Това са Историческия музей, Архитектурно-парков комплекс "Двореца", Етнографски музей и др.<br><br><br><br><span style="font-weight: normal;">.</span> ',
        coords: { lat: 43.4060, lng: 28.1483 } 
    },
    { 
        id: 'b055', title: '- Калиакра', location: 'Калиакра', 
        isCollected: false, isWanted: false, 
        imagePath: 'Images/Books/b055.png', 
        description: 'Нос Калиакра е живописен скалист нос, разположен на северното Черноморие на България, близо до град Каварна. Мястото е известно с драматичните си скали, издигащи се над морето, и впечатляващите панорамни гледки. На нос Калиакра се намират останките на средновековна крепост и древни укрепления, свързани с легенди и исторически събития.<br><br><br><br><span style="font-weight: normal;">.</span>',
        coords: { lat: 43.3610, lng: 28.4657 } 
    },
        { 
