...
let allBooks = [
    ...
    { 
     ...
     { 
        ...
        description: 'Град в Североизточна България с богата история и стратегическо значение. Над него се намира Шуменска крепост, която има тракийско, римско и средновековно минало. В близост до града се намира Паметник „Създатели на българската държава“, посветен на 1300-годишнината на България. ',
    ...
    { 
        ...
        description: 'Уникален скален релеф, изсечен върху отвесна скала край село Мадара. Датиран е през VIII век и изобразява конник в естествена големина, който пронизва лъв с копие. Паметникът е свързан с ранната българска държава. Включен в списъка на световното културно наследство на ЮНЕСКО.',
